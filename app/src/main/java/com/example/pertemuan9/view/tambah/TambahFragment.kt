package com.example.pertemuan9.view.tambah
...
import com.example.pertemuan9.databinding.FragmentTambahBinding
...
class TambahFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.insertMahasiswa().observe(viewLifecycleOwner){
            if (it != null){
                findNavController().navigate(R.id.action_tambahFragment_to_homeFragment2)
